...
class BertTokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=True, max_len=None, never_split=("[UNK]", "[SEP]", "[X_SEP]", "[PAD]", "[CLS]", "[MASK]","<#Q2K#>","<#K#>","<#Q#>","<#Q2R#>","[#2R#]","[#2K#],<#K2R#>")):
...
class BasicTokenizer(object):
    ...
    def __init__(self, do_lower_case=True, never_split=("[UNK]", "[SEP]", "[PAD]", "[CLS]", "[MASK]", "<#Q2K#>","<#K#>","<#Q#>","<#Q2R#>","[#2R#]","[#2K#],<#K2R#>")):
