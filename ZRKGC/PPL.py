...
from PPL_modeling import BertForPreTrainingLossMask
from optimization import BertAdam, warmup_linear

from nn.data_parallel import DataParallelImbalance
import PPL_loader as seq2seq_loader
			...
			for qkr_dev_step, batch in enumerate(dev_iter_bar):
				...
				with torch.no_grad():
					...
					loss_tuple = model(input_ids, segment_ids, input_mask, lm_label_ids, is_next,
									   ...
									   labels=labels, ks_labels=ks_labels, train_vae=args.train_vae,style_ids=style_ids, style_labels=style_labels,check_ids=check_ids,pretrain=None)
